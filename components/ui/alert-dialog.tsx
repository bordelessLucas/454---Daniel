...
const AlertDialogHeader = ({
  ...
  <div
    className={cn(
      'flex flex-col space-y-2 border-b border-border/60 bg-muted/20 px-6 py-5 text-center sm:px-8 sm:py-6 sm:text-left',
      className,
    )}
    {...props}
  />
...
const AlertDialogFooter = ({
  ...
  <div
    className={cn(
      'flex flex-col-reverse gap-3 border-t border-border/60 px-6 py-5 sm:flex-row sm:justify-end sm:space-x-0 sm:px-8 sm:py-6',
      className,
    )}
    {...props}
  />
